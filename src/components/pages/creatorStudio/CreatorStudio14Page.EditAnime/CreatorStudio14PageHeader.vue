...
// Component refs.
const artworkDetailRoute = ref(null);
...
onBeforeMount(() => {
    defaultRedirectRoute.value = `/studio/anime/detail/${props.animeId}`;
    artworkDetailRoute.value = `/studio/anime/detail/${props.animeId}`;
