...
import { CreatorStudio16AnimeDetailRouteName } from "src/router/creatorStudio/CreatorStudio16PageRoute";
import { CreatorStudio17EditAnimeChapterRouteName } from "src/router/creatorStudio/CreatorStudio17PageRoute";

export default {
    name: "StudioAnimeChapterCard",
    emits: ["removeItem"],
    props: {
        id: {
            required: true,
