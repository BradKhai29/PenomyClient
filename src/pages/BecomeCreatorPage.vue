<template>
    <section id="header-section" class="flex justify-center">
        ...
        >
            ...
            >
                Đăng ký trở thành nhà sáng tạo nội dung
            </div>
    ...
    <section id="main-section" class="flex justify-center q-mt-sm">
        ...
        >
            ...
            <p class="q-mt-md">
                1. Khi bạn đã xác nhận đăng ký trở thành nhà sáng tạo nội dung
                trên nền tảng Penomy đồng nghĩa với việc bạn đã đồng ý và tuân
                thủ với
                <router-link
                    class="underline-none text-weight-bold text-primary"
                    >quy tắc cộng đồng</router-link
                >
                và
                <router-link
                    class="underline-none text-weight-bold text-primary"
                    >quy tắc nội dung</router-link
                >
                do Penomy quy định.
            </p>
            <p>
                2. Nếu bạn bị phát hiện vi phạm quy tắc khi đăng tải nội dung
                trên nền tảng, Penomy yêu cầu bạn hợp tác gỡ bỏ các nội dung này
                khỏi nền tảng. Trong trường hợp vi phạm nghiêm trọng, nền tảng
            ...
            <p>
                ...
                tình không tuân thủ quy tắc cộng đồng, Penomy có quyền áp dụng
                các biện pháp xử lý nghiêm khắc hơn. Điều này bao gồm, nhưng
                không giới hạn, việc
                <router-link
                    class="underline-none text-weight-bold text-dark-500"
                    >cấm tạm thời hoặc vĩnh viễn tài khoản của bạn</router-link
                >
        ...
        >
            ...
            <p class="q-mt-md">
                1. Nội dung do bạn đăng tải phải do chính bạn tạo ra và có bản
                quyền toàn diện đối với những nội dung này, nền tảng nghiêm cấm
                các trường hợp sao chép hoặc đăng tải các nội dung vi phạm quyền
                sở hữu trí tuệ của bên thứ ba.
            </p>
            <p>
                2. Nghiêm cấm nội dung liên quan đến các quan điểm chính trị gây
                tranh cãi, kích động, hoặc các vấn đề tôn giáo mang tính xúc
                phạm, phân biệt đối xử, các nội dung lừa đảo, xuyên tạc, hoặc cổ
                vũ hành vi phạm pháp. Nghiêm cấm tuyệt đối các nội dung kích
                động bạo lực, phân biệt chủng tộc, kỳ thị giới tính, hoặc bất kỳ
                hình thức thù ghét nào.
            </p>
            <p>
        ...
        >
            ...
            <p class="q-mt-md">
                ...
                nhận phần chia sẻ doanh thu từ nội dung của mình dựa trên lượt
                xem và sự ủng hộ từ phía người dùng.
            </p>
            <p>
                2. <strong>Hỗ trợ cá nhân hóa</strong>: Nhà sáng tạo có quyền
                tùy chỉnh hồ sơ, trang cá nhân, và xây dựng thương hiệu riêng
                trên nền tảng.
            </p>
            <p>
                3. Để xem chi tiết, vui lòng truy cập vào trang
                <router-link
                    class="underline-none text-weight-bold text-primary"
                    >quyền lợi cho nhà sáng tạo</router-link
                >
                của Penomy.
            </p>
        </div>
        ...
        >
            ...
            >
                ...
                <span class="text-subtitle1">
                    Tôi xác nhận rằng mình đã đọc, hiểu rõ và cam kết tuân thủ
                    đầy đủ các quy tắc và điều khoản sử dụng của nền tảng.
                </span>
            </div>
    ...
    >
        ...
        >
            <router-link class="underline-none text-weight-bold text-dark-500">
                {{ userNickname }}
            </router-link>
