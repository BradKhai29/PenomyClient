...
import { CreatorStudio12ApiHandler } from "src/api.handlers/creatorStudio/creatorStudio12Page/CreatorStudio12ApiHandler";
import { useUserProfileStore } from "src/stores/common/UserProfileStore";

import CreatorStudio12PageHeader from "src/components/pages/creatorStudio/creatorStudio12Page/CreatorStudio12PageHeader.vue";
...
export default {
    ...
    methods: {
        ...
        async createNewAnime() {
            ...
            const result = await CreatorStudio12ApiHandler.createArtworkAsync(
                this.artworkDetail
            );
