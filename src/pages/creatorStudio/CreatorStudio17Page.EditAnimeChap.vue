<template>
    <q-page v-if="!isLoading">
        <CreatorStudio17PageHeader
            :headerTitle="chapterDetail.animeTitle"
                ...
                <div class="col-sm-6 col-md-8 col-grow">
                    ...
                    >
                        ...
                        <AnimeChapterVideoInput
                            ...
                            :presetVideoSrc="chapterDetail.chapterVideoUrl"
                            :presetVideoSize="chapterDetail.totalMediaSize"
                            class="q-mb-md"
                        />
...
import {
    EditAnimeChapterApiHandler,
    ChapterUpdateModes,
} from "src/api.handlers/creatorStudio/creatorStudio17Page.EditAnimeChap/EditAnimeChapterApiHandler.js";
import { EditAnimeChapterDetailRequestDto } from "src/api.models/creatorStudio/creatorStudio17Page.EditAnimeChap/EditAnimeChapterDetailRequestDto.js";

// Import components section.
import CreatorStudio17PageHeader from "src/components/pages/creatorStudio/creatorStudio17Page.EditAnimeChap/CreatorStudio17PageHeader.vue";
...
export default {
    ...
    data() {
        return {
            ...
            /**
             * @type {EditAnimeChapterDetailRequestDto} The type of this property.
             */
            chapterDetail: new EditAnimeChapterDetailRequestDto(),
    ...
    async mounted() {
        const apiResponse =
            await EditAnimeChapterApiHandler.getChapterDetailByIdAsync(
