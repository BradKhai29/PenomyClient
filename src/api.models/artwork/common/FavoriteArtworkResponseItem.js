...
class FavoriteArtworkResponseItem {
    /**
     ...
     *
     * @param {FavoriteArtworkResponseItem} apiResponse The api response to map from.
     * @returns {FavoriteArtworkResponseItem} The instance after mapping.
     */
    static mapFrom(apiResponse) {
        return new FavoriteArtworkResponseItem(
            apiResponse.id,
            apiResponse.title,
     ...
     *
     * @param {FavoriteArtworkResponseItem[]} responseItems The array of items to map from.
     * @returns {FavoriteArtworkResponseItem[]} The array of instance after mapping.
     */
...
export { FavoriteArtworkResponseItem, ChapterResponseItem };
